...
#[get("/clerks")]
pub fn clerks(user: User) -> Template {
...
#[get("/depoimentos")]
pub fn depos(_user: User) -> Template {
...
pub fn depos_no_login() -> Template {
...
pub fn get_answer_email(
    ...
    let mail_data = call_email::table
        ...
        .filter(call_email::user_id.eq(user.user_id as i32))
        .filter(call_email::call_email_id.eq(mail_id))
        .load::<(Option<NaiveDateTime>, Option<String>, Option<String>)>(&crate::establish_connection())
        .expect("Shit happens.");
